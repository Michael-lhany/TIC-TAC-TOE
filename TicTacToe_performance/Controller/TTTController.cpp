      ...
      currentPlayer_(BoardMarks::X)
{
    ...
    connect(timer, &QTimer::timeout, this, &TTTController::updatePerformanceMetrics);
    timer->start(1000);
    // Build GUI
...
void TTTController::updatePerformanceMetrics()
{
...
void TTTController::AIAgentPlay()
{
    ...
    qDebug() << "Move calculation time: " << duration.count() << " seconds";
}
